...
// Implement is a kind of interface, 'Comparable' used to make the object comparable
public class UTXO implements Comparable<UTXO> {
    ...
    /**
     * Simple implementation of a Main.UTXO hashCode that respects equality of UTXOs // (i.e.
